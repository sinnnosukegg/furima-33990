...
ActiveRecord::Schema.define(version: 2021_02_09_102207) do
  ...
  create_table "shipping_areas", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["record_id"], name: "index_shipping_areas_on_record_id"
  end
  ...
  add_foreign_key "shipping_areas", "records"
end
